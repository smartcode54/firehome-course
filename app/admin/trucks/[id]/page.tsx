...
import { ArrowLeft, Edit, Truck, Calendar, Fuel, Scale, User, FileText, Info } from "lucide-react";
...
export default async function TruckPreviewPage({
    params,
}: {
    params: { id: string };
}) {
    // Await params object for dynamic routing (required in Next.js 15+ if enabled, safe for 14)
